...
sed -i.bak "s/your-gcp-project-id/$PROJECT_ID/g" deploy.sh
sed -i.bak "s/us-central1/$REGION/g" deploy.sh
sed -i.bak "s/your-service-account@your-project-id.iam.gserviceaccount.com/$SERVICE_ACCOUNT_EMAIL/g" deploy.sh
sed -i.bak "s|https://your-project-id.supabase.co|$SUPABASE_URL|g" deploy.sh
